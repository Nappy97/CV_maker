...
public class CVAboutProject extends BaseEntity {
    ...
    public static CVAboutProject createCVAboutProject(CVAboutProjectList cvAboutProjectList, String title,
                                                      String intro, LocalDateTime startedDate, LocalDateTime completionDate,
